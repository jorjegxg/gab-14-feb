...
export default function Home() {
  return (
    <div style={{ textAlign: "center", marginTop: "50px" }}>
      <h1>Pagina Statică de Test</h1>
      <p>Acesta este un exemplu simplu de pagină statică în Next.js.</p>
      <p>
        Dacă poți vedea acest text, înseamnă că totul este configurat corect!
      </p>
    </div>
  );
}
